      ...
      <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li><a class="nav-link scrollto" href="All_projects.php">All Projects</a></li>
        ...
        <a href="profile.php"><i class="bi bi-file-person-fill text-primary fs-1" id="profile"></i></a>
        </nav><!-- .navbar -->
      </div>
      </header><!-- End Header -->
      <!-- ======= Hero Section ======= -->
